...
2.	| Economics_spreadsheet | – intervention costs, resource allocation, ROI calculations.
...
6.	| Deployment_dimensional | – endpoints, runtime configurations, API keys, server settings for 
